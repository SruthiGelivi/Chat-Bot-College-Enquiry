...
//var fb = new Firebase("https://fir-aa253.firebaseio.com"); //ur firebase url
...
imageApp.controller("SecureController", function($scope, $ionicHistory, $firebaseArray, $firebaseAuth, $cordovaCamera,$state) {
    ...
    if(fbAuth) {
        var userReference = $scope.fb.$child("users/" + fbAuth.uid);   //capture the user reference in data structure ,it navigates to specific user page in freebase
